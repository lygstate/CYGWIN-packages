...
sh build-single.sh autoconf2.73
...
sh build-single.sh perl-Class-Inspector
...
sh build-single.sh perl-File-ShareDir-Install
...
sh build-single.sh perl-File-ShareDir
