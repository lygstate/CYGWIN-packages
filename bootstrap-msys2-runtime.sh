...
tar xf ./dist/msys2-runtime-devel-3.6.5.3-1-x86_64.pkg.tar.zst  -C /
tar xf ./dist/msys2-runtime-3.6.5.3-1-x86_64.pkg.tar.zst  -C /

tar xf ./dist/msys2-runtime-devel-3.6.5.1-1-x86_64.pkg.tar.zst  -C /
tar xf ./dist/msys2-runtime-3.6.5.1-1-x86_64.pkg.tar.zst  -C /

tar xf ./dist-init/msys2-runtime-devel-3.6.5-1-x86_64.pkg.tar.zst  -C /
tar xf ./dist-init/msys2-runtime-3.6.5-1-x86_64.pkg.tar.zst  -C /

tar xf ./dist/msys2-runtime-devel-3.6.5.5-1-x86_64.pkg.tar.zst  -C /
tar xf ./dist/msys2-runtime-3.6.5.5-1-x86_64.pkg.tar.zst  -C /
